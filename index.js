...
class Codesty extends Client {
 ...
 ok = "<a:0667_onay_667:891732555605356604>"
 no = "<a:0667_red_667:891732556087705631>"
 serverID = "834486813618864149"
 logChannel = "891779117610045440"
 allowedOwners = ["367398773921546240"]
 owner = ["615471204966596609", "139783252079542272"]
...
client.login("OTA5Nzg1MDY2NzYxMjI4MzE5.YZJVXg.LiGbaFWyIzoGI1JfEECNYchdEto");
mongoose.connect('mongodb+srv://spect:667@cluster0.1mwym.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true})
...
client.on("roleDelete", role => {
  client.channels.cache.get("891779117610045440").send("@everyone <a:0667_red_667:891732556087705631> Silinen Rol ID: `" + role.id + "`");
  client.channels.cache.get("891779117610045440").send("@everyone <a:0667_red_667:891732556087705631> Silinen Rol İsim: `" + role.name + "`");
});
